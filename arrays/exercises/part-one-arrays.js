...
//Use the push method to add "42" and "hello" to the array. Add these new items one at a time.  Print the array after each step to confirm the changes.
...
practiceFile.push("false",-4.5,"87");
console.log(practiceFile);